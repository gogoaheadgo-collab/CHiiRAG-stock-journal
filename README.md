...
Target URL: **chiirag-jornal.vercel.app**
...
3. Name: `chiirag-stock-journal`
4. Keep it Private → Click **Create repository**
5. Open terminal / command prompt on your computer:

```bash
cd path/to/chiirag-stock-journal
git init
git add .
git commit -m "Initial commit"
git branch -M main
git remote add origin https://github.com/YOUR-USERNAME/chiirag-stock-journal.git
...
3. Import your `chiirag-stock-journal` repository
...
7. Add custom domain: `chiirag-jornal.vercel.app`
   - Actually Vercel auto-assigns: `chiirag-stock-journal.vercel.app`
   - To get `chiirag-jornal.vercel.app` exactly, name your Vercel project `chiirag-jornal`
...
2. Set **Site URL**: `https://chiirag-jornal.vercel.app`
3. Under **Redirect URLs**, add: `https://chiirag-jornal.vercel.app`
4. Save
...
Your journal is live at **chiirag-jornal.vercel.app**
